...
<div class="form-group d-flex flex-column justify-content-center align-items-center" style="height: 575px;">
    ...
    <form method="post" class="col-6">
        ...
        <div class="mb-3 gap-1 justify-content-center d-flex">
            <button type="button" class="btn btn-warning d-flex align-items-center p-1" data-bs-toggle="modal"
        ...
        <div class="container d-flex justify-content-center">
            ...
            <button type="submit" name="upd_article" class="btn btn-success">Update</button>
        </div>
    </form>
</div>
<?php
